...
/// <summary>
/// Thrown by <see cref="Admin.IAuthzAdminClient.ProvisionTenantAsync"/> and
/// <see cref="Admin.IAuthzAdminClient.SyncCatalogAsync"/> when ms-authz rejects the request with a
