...
/// "Includes" lists other roles whose permissions this role inherits, transitively.
/// </summary>
public sealed record CatalogFileRole(string Code, string Name, string? Description, List<string>? Permissions, List<string>? Includes);
